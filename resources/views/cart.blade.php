                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        ...
                                        <div class="cart-product__item">
                                            <a href="#">
                                                <img src="{{asset('uploads/products/'. $pdt->model->image)}}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                            </a>
                                    ...
                                    <td class="product-price">
                                        <h5 class="price amount">${{number_format($pdt->price)}}</h5>
                                    </td>
                                    ...
                                    <td class="product-subtotal">
                                        <h5 class="total amount"> ${{number_format($pdt->total())}}</h5>
                                    </td>
