                                ...
                                <div class="logos">
                                    ...
                                    <span style="float: right;">
                                        <form action="{{ route('cart.checkout') }}" method="POST">
                                            {{ csrf_field() }}
                                            <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="pk_test_KSOuIDyOyCOvhgXYolzEe90S00UlQQ0n02" data-amount="{{ Cart::total() * 100 }}" data-name="Programming Bookshop" data-description="Buy some books" data-image="https://stripe.com/img/documentation/checkout/marketplace.png" data-locale="auto">
                                            </script>
                                        </form>
                                    </span>
                                </div>
